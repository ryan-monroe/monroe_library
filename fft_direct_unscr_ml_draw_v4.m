...
for(i=1:vec_count_linear)
    ...
    blockTemp = xBlock(struct('source', str2func('coeff_gen_dual_draw'), 'name',blockName), {coeff_array(1:2^(coeff_step_rate):end,i), 'Block RAM', coeff_bit_width, coeff_step_rate , 0});
