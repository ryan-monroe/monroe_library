...
if(real_inputs==1)
    ...
    blockTemp = xBlock(struct('source', str2func('biplex_2x_unscr_draw'), 'name','biplex_4x_unscr'), {FFTSize, bram_latency_unscr, inter_stage_bit_width(FFTSize), unscr_din_latency}, ... 
