...
function biplex_stage_n_draw(FFTSize, FFTStage, input_bit_width, coeff_bit_width, output_bit_width, delays_bram, bram_latency, shift, delay_arr, mux_latency,arch)
