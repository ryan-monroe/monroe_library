...
sConstVal_0 = xConstVal(0, 'Signed', bit_width, bit_width-2, 'Constant3');
...
if(strcmp(memory_type,'Block RAM')) %distributed coeffs don't benefit from the longer delay (it's worse in fact!) but they could use some fanout reduction on the input.  So there you go.
    sCountPreSlice = iCount;
    ramLag=2;
else
    sCountPreSlice = xDelay(iCount,1,'counterDelayDist');
    ramLag=1;
end
...
xlsub2_Dual_Port_RAM4_out1 = xSignal;
xlsub2_Dual_Port_RAM4_out2 = xSignal;
