...
function direct_coeff_gen_draw_v3(FFTSize, larger_FFTSize, bit_width, register_coeffs, delay_input, sync_tree_input, optional_delay_arr, coeff_group_arr_in, coeff_stage_step_arr, radix4)
...
stage_delay_arr = 6* ones(1,FFTSize)+2;%plus 2 for rounding
if(radix4)
    for i=1:FFTSize
