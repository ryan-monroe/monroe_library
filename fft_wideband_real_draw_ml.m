...
function fft_wideband_real_draw_ml(FFTSize  ,n_sim_inputs  ,input_bit_width  ,coeff_bit_width ,inter_stage_bit_width_biplex ,inter_stage_bit_width_direct ,output_bit_width ,register_coeffs_biplex  ,register_coeffs_direct ,delay_between_biplex_direct ,delay_output  ,inter_stage_delays_direct  ,shift_array  ,super_unscr  ,coeff_group_arr_in ,max_distro_size_coeff  ,max_distro_size_delay ,biplex_delay_mid  ,biplex_delay_end ,biplex_mux_latency  ,biplex_bram_latency_fft ,biplex_bram_latency_unscr  ,unscr_din_latency, share_coeffs_biplex)%, n_pfb_taps, pfb_coeff_bits, pfb_bits_out, delay_pfb_biplex, )
%  xBlock;
% 
% FFTSize = 8;
% n_sim_inputs = 4;
...
if(length(biplex_mux_latency) == 1)
    biplex_mux_latency = biplex_mux_latency *ones(1,FFTSize);
end
...
if(length(inter_stage_bit_width_biplex) == 1)
    inter_stage_bit_width_biplex = inter_stage_bit_width_biplex *ones(1,biplex_len);
end
...
if(share_coeffs_biplex ==1)
    ...
    for(i=1:max((2^(n_sim_inputs-3)),1)) 
        ...
        blockTemp = xBlock(struct('source', str2func('biplex_coeff_muxsel_gen_draw_v2'), 'name',['biplex_muxsel_gen_', num2str(i-1)]), ...
            {biplex_len, coeff_bit_width(biplex_stages(3:end)), ...
...
if(super_unscr == 0)
    ...
    sDirectSyncOut= xSignal;
       ...
       xBlock( struct('name', blockName, 'source', str2func('fft_direct_unscr_ml_draw_v3')), ...
            {  ...
            FFTSize ,...
            n_sim_inputs-1,...
            biplex_bram_latency_unscr ,...
