...
blockTemp = xBlock(struct('source', str2func('biplex_coeff_muxsel_gen_draw'), 'name','biplex_muxsel_gen'), {FFTSize, coeff_bit_width, register_coeffs, max_distro_size_coeff, optional_delay_arr, stage_delay_arr, mux_latency_arr}, {iSync}, {sCoeffAll,sSelAll,sSyncCoreOut});
