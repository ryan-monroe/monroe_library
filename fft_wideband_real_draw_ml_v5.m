...
function fft_wideband_real_draw_ml_v3(FFTSize  ,n_sim_inputs  ,input_bit_width  ,coeff_bit_width ,inter_stage_bit_width ,output_bit_width ,register_coeffs_biplex  ,register_coeffs_direct ,delay_between_biplex_direct ,delay_output  ,inter_stage_delays_direct  ,shift_array  ,super_unscr  ,coeff_group_arr_in ,max_distro_size_coeff  ,max_distro_size_delay ,biplex_delay_mid  ,biplex_delay_end ,biplex_mux_latency  ,biplex_bram_latency_fft ,biplex_bram_latency_unscr  ,unscr_din_latency, direct_coeff_step_rate,updateCoeffs)
%  xBlock;
% 
% FFTSize = 8;
% n_sim_inputs = 4;
...
if(super_unscr == 0)
    ...
    sDirectSyncOut= xSignal;
       ...
       xBlock( struct('name', blockName, 'source', str2func('fft_direct_unscr_ml_draw_v7')), ...
            ...
            output_bit_width ,...
            shift_array(end), ...
            direct_coeff_step_rate(end), updateCoeffs
            }, ...
            ...
