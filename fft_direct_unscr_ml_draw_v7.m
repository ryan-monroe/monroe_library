...
function fft_direct_unscr_ml_draw_v9(FFTSize, FFT_Direct_Size, bram_latency,bit_width,coeff_bit_width, out_bit_width, shift, coeff_step_rate, updateCoeffs)
...
%         b_in = sOdd_cc2_delay{i};
    ...
    blockName = strcat('coeff_gen',num2str(i-1));
     blockTemp = xBlock(struct('source', str2func('coeff_gen_dual_draw_v2'), 'name',blockName), {coeff_array(1:2^(coeff_step_rate):end,i), 'Block RAM', coeff_bit_width, coeff_step_rate , 0, 0, updateCoeffs});
